...
try:
    ...
    class build:
        ...
        def __call__(*args, **kwargs):
            raise ImportError("Google API not available")
    class MediaIoBaseDownload:
        pass

# Try to import configuration with fallback
try:
    from config import (
    ...
    CACHE_CONFIG = {'timeout': 3600}
    API_CONFIG = {}
    SECURITY_CONFIG = {}
    DEPLOYMENT_MODE = type('DeploymentMode', (), {'value': 'development'})()
